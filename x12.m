...
noise = 0.2*cos(2*pi*30*10^3*tt2);                                 
signal_noise =xFS2+ noise(1:len_xFS2);                
sound(signal_noise,FS2);
pause(5);
figure( 'Name','叠加30k正弦信号噪声后的音频信号','Position',[450,350,400,300] );
...
ap=1;
as=60;
[n,c]=buttord(WP,WS,ap,as,'s');
[b,a]=butter(n,c,'s');
[b1,a1]=impinvar(b,a,FS2);
